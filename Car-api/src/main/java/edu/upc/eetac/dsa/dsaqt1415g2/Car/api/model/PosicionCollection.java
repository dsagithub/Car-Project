...
public class PosicionCollection 
{
	@InjectLinks
	({
	   @InjectLink(value ="/posicion?username={username}",style = Style.ABSOLUTE, rel = "one user's posicions", title = "Get-posicions by username", type = MediaType.CAR_API_POSICION_COLLECTION,bindings = { @Binding(name = "username", value = "${instance.username}") })
	})
